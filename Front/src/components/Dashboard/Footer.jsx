              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    ...
                    <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Seasonal Deals</a></li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Become a Host</a></li>
                    <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Host Resources</a></li>
          ...
          <div className="mt-16 pt-8 border-t border-gray-800">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex space-x-6 mt-4 md:mt-0">
                ...
                <a href="#" className="text-sm text-gray-500 hover:text-gray-400 transition-colors">Sitemap</a>
              </div>
            </div>
            <div className="mt-4 text-xs text-gray-600">
              <p>Voyageur is a registered trademark of Voyageur, Inc. All other trademarks are property of their respective owners.</p>
            </div>
          </div>
        </div>
      </footer>

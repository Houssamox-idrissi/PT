...
export default function RegisterForm() {
  ...
  // List of nationalities for select input
  const nationalities = [
    "American", "Morocco", "Canadian", "French", "German", 
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-cyan-500 p-6 text-center relative overflow-hidden">
            ...
            <h2 className="text-3xl font-bold text-white relative z-10">
              Join <span className="font-serif italic">Voyageur</span>
            </h2>
            <p className="text-blue-100 mt-2 relative z-10">Create your traveler account</p>
          </div>
          ...
          <div className="p-8">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                ...
                <a href="/loginVoyageure" className="font-medium text-blue-600 hover:text-blue-500">
                  Sign in
                </a>
              </p>
            </div>

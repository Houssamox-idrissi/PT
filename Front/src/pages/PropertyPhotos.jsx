            ...
            {photos.length === 0 ? (
              ...
              >
                <div className="mx-auto w-24 h-24 mb-6">
                  <img src="/images/camera.png" alt="Camera" className="w-full h-full object-contain" />
                </div>
          ...
          <div className="bg-white rounded-2xl w-full max-w-2xl p-6">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-xl font-medium">
                Ajoutez des photos
                {selectedPhotos.length > 0 && ` (${selectedPhotos.length} élément sélectionné)`}
              </h3>
              <button
            ...
            {selectedPhotos.length === 0 ? (
              ...
              >
                ...
                <p className="text-lg font-medium mb-2">Glissez-déposez un fichier</p>
                <p className="text-gray-500 mb-4">ou recherchez des photos</p>
                <button
            ...
            <div className="flex justify-between mt-6">
              <button
                onClick={() => setIsModalOpen(false)}
                className="px-4 py-2 text-gray-700 font-medium hover:underline"
              >
                Annuler
              </button>
              <button
